...
public class Client extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jComboBox1.getSelectedIndex()==0){
            try {
                LocalDateTime currentTime_global = LocalDateTime.now();
                write("send-to-global"+","+messageContent+","+this.id);
                jTextArea1.setText(jTextArea1.getText()
                        +currentTime_global.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))
                        +" Bạn: "
                        +messageContent+"\n");
            ...
            try {
                LocalDateTime currentTime_person = LocalDateTime.now();
                String[] parner = ((String)jComboBox1.getSelectedItem()).split(" ");
                write("send-to-person"+","+messageContent+","+this.id+","+parner[1]);
                jTextArea1.setText(jTextArea1.getText()
                        +currentTime_person.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))
        ...
        try {
            thread = new Thread() {
                ...
                public void run() {
                    ...
                    try(Socket socketOfClient = new Socket("localhost", 7777)){
...
//                    socketOfClient.close();
                        ...
                        JOptionPane.showMessageDialog(null, "Server chưa được khởi động!");
                        disposeFrame();
                        return;
                    } catch (IOException e) {
                        UIManager.put("OptionPane.messageForeground", java.awt.Color.RED);
